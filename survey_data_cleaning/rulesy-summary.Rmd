...
```{r}
persons_days_ungroup<-tripuser_added%>%group_by(person_id,daynum)
```

```{r}
bad_days<-slice_sample(persons_days_ungroup,n=10)
```

```{r}
write.csv(bad_days,'bad_recs_is_complete_a.csv')
```

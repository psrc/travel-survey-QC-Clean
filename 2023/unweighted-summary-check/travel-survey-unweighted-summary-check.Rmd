...
hh_rulesy<-get_table(db_name = "HouseholdTravelSurvey2023", "combined_data", "v_household")%>%filter(hh_iscomplete_b==1)
person_rulesy<-get_table(db_name = "HouseholdTravelSurvey2023", "combined_data", "v_person")%>%filter(hh_iscomplete_b==1)
day_rulesy<-get_table(db_name = "HouseholdTravelSurvey2023", "combined_data", "v_day")%>%filter(hh_day_iscomplete_b==1)
trip_raw<-get_table(db_name = "HouseholdTravelSurvey2023", "combined_data", "v_trip")%>%filter(hh_day_iscomplete_b==1)
trip_rulesy<-get_table(db_name = "hhts_cleaning", "HHSurvey", "Trip")%>%filter(hh_day_iscomplete_b==1)
